...
import { ActiveNode } from '@milkdown/kit/plugin/block'
import { pageBlockServiceInstance } from './pb-plugin'
...
export interface PageBlockProviderOptions {
...
export class PageBlockProvider {
  /// @internal
  ...
  constructor(options: PageBlockProviderOptions) {
  ...
  #init() {
    ...
    const service = this.#ctx.get(pageBlockServiceInstance.key)
