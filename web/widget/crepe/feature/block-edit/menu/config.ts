...
export function getGroups(
  ...
  const isLatexEnabled =      config?.isLatexEnabled ?? false
  const isImageBlockEnabled = config?.isImageBlockEnabled ?? false
  const isTableEnabled =      config?.isTableEnabled ?? false
